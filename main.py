...
class Main(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.sth1 = QPushButton()
        self.sth2 = QPushButton()
        self.sth3 = QPushButton()
        self.sth4 = QPushButton()
    ...
    def init_ui(self):
        ...
        self.sth1 = QPushButton('ФОРМА ЗАПРОСА', self)
        self.sth1.clicked.connect(self.func2)
        self.sth1.setGeometry(160, 390, 400, 80)
        self.sth1.setStyleSheet("background-image: url(res/pic/7.jpg);")
        self.sth2 = QPushButton('БАЗA ДАННЫХ  МАТЕРИАЛОВ', self)
        self.sth2.setGeometry(160,120, 400, 80)
        self.sth2.setStyleSheet("background-image: url(res/pic/7.jpg);")
        ...
        self.sth3.setGeometry(160, 260, 400, 80)
        self.sth3.setStyleSheet("background-image: url(res/pic/7.jpg);")
        self.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        self.sth4 = QPushButton('ПРОГНОЗНЫЕ ИНДЕКСЫ', self)
        self.sth4.clicked.connect(self.func5)
        self.sth4.setGeometry(160, 520, 400, 80)
        self.sth4.setStyleSheet("background-image: url(res/pic/7.jpg);")
...
class Window2(QWidget):
    ...
    def init_ui1(self):
        ...
        self.pole5.setPixmap(QPixmap("res/pic/321.jpg"))
        self.pole5.setGeometry(110, 440, 400, 400)
        #######
        self.sth20 = QPushButton('ОК', self)
        self.sth20.setGeometry(180, 325, 200, 75)
        self.sth20.setStyleSheet("background-image: url(res/pic/7.jpg);")
        self.pole6 = QLabel(self)
        self.pole6.setPixmap(QPixmap("res/pic/img_1.png"))
    ...
    def insert(self):
        param_dict = dict()
        param_dict['Normativ'] = self.pole1.text()
        param_dict['Kod_KKM'] = self.pole2.text()
        param_dict['Naimenovanie_materiala'] = self.pole3.text()
        param_dict['Naimenovanie_smeta'] = self.pole110.text()
        param_dict['Ediniza_izm'] = self.pole111.text()
        param_dict['PTM'] = self.pole112.text()
        param_dict['Haracteristica'] = self.pole113.text()
        param_dict['Primechanie'] = self.pole114.text()
        param_dict['PRICE'] = self.pole4.text()
        self.db.insert(**param_dict)
        self.db.select()
...
class Window3(Main):
    ...
    def initUi3(self):
        ...
        self.pole201.setStyleSheet("background-image: url(res/pic/44444-4.jpg);")
        ...
        self.sth303.setStyleSheet("background-image: url(res/pic/7.jpg);")
        self.edit = QLineEdit(self)
        self.edit.setGeometry(1700, 430, 175, 70)
        self.edit.setStyleSheet("background-image: url(res/pic/44444-4.jpg);")
    ...
    def update(self):
        ...
        self.db.update(self.id, self.Normativ, self.Kod_KKM, self.Naimenovanie_materiala, self.Naimenovanie_smeta,
                       self.Ediniza_izm, self.PTM, self.Haracteristica, self.Primechanie, self.PRICE)
        self.select()
...
class Window4(Main):
    ...
    def initUi4(self):
        ...
        self.setMinimumWidth(1910)
        self.setMinimumHeight(990)
        self.setStyleSheet("background-image: url(res/pic/44444-4.jpg);")
        ...
        self.sth303 = QPushButton('СОХРАНИТЬ ФАЙЛ В ЕХСЕЛ', self)
        self.sth303.setGeometry(1700, 270, 180, 85)
        self.pole5 = QLabel(self)
        self.pole5.setPixmap(QPixmap("res/pic/502.jpg"))
        self.pole5.setGeometry(1685, 380, 250, 520)
        self.sth303.setStyleSheet("background-image: url(res/pic/7.jpg);")
        self.pole401 = QLineEdit(self)
        self.pole401.setGeometry(1700, 200, 170, 50)
        self.pole401.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole402 = QLineEdit(self)
        # self.pole402.setGeometry(1700, 270, 70, 50)
        # self.pole402.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole403 = QLineEdit(self)
        # self.pole403.setGeometry(1700, 340, 70, 50)
        # self.pole403.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        ...
        # self.pole404.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole405 = QLineEdit(self)
        # self.pole405.setGeometry(1700, 490, 70, 50)
        # self.pole405.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole406 = QLineEdit(self)
        # self.pole406.setGeometry(1800, 200, 70, 50)
        # self.pole406.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole407 = QLineEdit(self)
        # self.pole407.setGeometry(1800, 270, 70, 50)
        # self.pole407.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole408 = QLineEdit(self)
        # self.pole408.setGeometry(1800, 340, 70, 50)
        # self.pole408.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole409 = QLineEdit(self)
        # self.pole409.setGeometry(1800, 410, 70, 50)
        # self.pole409.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole410 = QLineEdit(self)
        # self.pole410.setGeometry(1800, 490, 70, 50)
        # self.pole410.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole411 = QLineEdit(self)
        # self.pole411.setGeometry(1700, 560, 70, 50)
        # self.pole411.setStyleSheet("background-image: url(res/pic/1000.jpg);")
        # self.pole412 = QLineEdit(self)
        # self.pole412.setGeometry(1800, 560, 70, 50)
        # self.pole412.setStyleSheet("background-image: url(res/pic/1000.jpg);")

    def select2(self):
        id_list = self.pole401.text()
        ...
        self.data = self.db.select2(id_list)
        # self.data = self.db.select2(self.id, self.id2, self.id3, self.id4, self.id5, self.id6, self.id7, self.id8,
        #                             self.id9, self.id10, self.id11, self.id12)
...
class Window5(Main):
    ...
    def initUi5(self):
        ...
        self.pole1.setGeometry(30, 760, 200, 70)
        #######
        self.gl101 = QLabel('ДАТА ', self)
        self.gl101.setStyleSheet('border:3px solid pink')
        self.gl101.setGeometry(270, 710, 200, 40)
        self.gl101.setWordWrap(True)
        self.pole10000 = QLineEdit(self)
        self.pole10000.setGeometry(270, 760, 200, 70)
        ##########
        self.gl102 = QLabel('ОБЩИЙ ИНДЕКС', self)
        self.gl102.setStyleSheet('border:3px solid pink')
        self.gl102.setGeometry(510, 710, 200, 40)
        self.pole10001 = QLineEdit(self)
        self.pole10001.setGeometry(510, 760, 200, 70)
        ###########
        self.gl110 = QLabel('ИНДЕКС СМР ', self)
        self.gl110.setWordWrap(True)
        self.gl110.setStyleSheet('border:3px solid pink')
        self.gl110.setGeometry(990, 710, 200, 40)
        self.pole10002 = QLineEdit(self)
        self.pole10002.setGeometry(990, 760, 200, 70)
        #########
        self.gl111 = QLabel('ИНДЕКС ОБОРУДОВАНИЕ', self)
        ####перенос текста
        self.gl111.setWordWrap(True)
        self.gl111.setStyleSheet('border:3px solid pink')
        self.gl111.setGeometry(1230, 710, 200, 50)
        self.pole10003 = QLineEdit(self)
        self.pole10003.setGeometry(1230, 760, 200, 70)
        ########
        self.gl1111 = QLabel('ИНДЕКС ПРОЧИЕ', self)
        self.gl1111.setStyleSheet('border:3px solid pink')
        self.gl1111.setGeometry(1470, 710, 200, 40)
        self.pole10004 = QLineEdit(self)
        self.pole10004.setGeometry(1470, 760, 200, 70)
        ########
    ...
    def select(self):
        ...
        if len(self.data) != 0:
            self.pig.setRowCount(len(self.data))
            self.pig.setColumnCount(len(self.data[0]))
            self.pig.setHorizontalHeaderLabels(["№п/п", 'ДАТА', "ОБЩИЙ ИНДЕКС", "ИНДЕКС СМР",
                                                "ИНДЕКС ОБОРУДОВАНИЯ", "ИНДЕКС ПРОЧИЕ"])
            for row, row_item in enumerate(self.data):
                for column, value in enumerate(row_item):
                    self.pig.setItem(row, column, QtWidgets.QTableWidgetItem(str(value)))
                    self.pig.setColumnWidth(0, 50)
    ...
    def insert(self):
        param_dict = dict()
        param_dict['data'] = self.pole10000.text()
        param_dict['index_ob'] = self.pole10001.text()
        param_dict['index_smr'] = self.pole10002.text()
        param_dict['index_obor'] = self.pole10003.text()
        param_dict['index_proch'] = self.pole10004.text()
        self.pb.insert(**param_dict)
        self.pb.select()
